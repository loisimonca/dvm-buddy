...
function EmployeeAccountSelectBar({ userData, setUserData}) {
  ...
  return (
    ...
    {state==="personal-info" && <EmployeePage userData={userData} setUserData={setUserData} />}
    {state==="patient-info" && <PatientInfoPage userData={userData} setUserData={setUserData} />}
    {state==="employee-info" && <EmployeeManagePage userData={userData} setUserData={setUserData} />}
    </>
  );
}
